! function(t) {
    ...
    function i(i, s) {
        this.element = i, this.settings = t.extend({}, n, s), this._defaults = n, this._name = e, this.init()
    }
    i.prototype = {
        init: function() {
        ...
        return this.each((function() {
            t.data(this, "plugin_numerator") && t.data(this, "plugin_numerator", null), t.data(this, "plugin_numerator", new i(this, e))
        }))
    }
}));